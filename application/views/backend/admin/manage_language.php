<div class="row">
    <div class="col-md-12">
        ...
        <!------KONTROL TABLARI BAŞLANGIÇ------>
        <ul class="nav nav-tabs bordered">
            <?php if(isset($edit_profile)):?>
                <li class="active">
                    <a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
                        <?php echo ('Deyimi Düzenle');?>
                    </a></li>
            <?php endif;?>
            <li class="<?php if(!isset($edit_profile))echo 'active';?>">
                <a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
                    <?php echo ('Dil Listesi');?>
                </a></li>
            <li>
		...
		<div class="tab-content">
            <!----DEYİM DÜZENLEME TABLOSU BAŞLANGIÇ-->
            <?php if (isset($edit_profile)):?>
                <div class="tab-pane active" id="edit" style="padding: 5px">
                    <div class="">
						...
						<div class="row">
                            ...
                            {
                                $count++;
                                $phrase_id			=	$row['phrase_id'];					// deyim id numarası
                                $phrase				=	$row['phrase'];						// temel deyim metni
                                $phrase_language	=	$row[$current_editing_language];	// mevcut düzenleme dilindeki deyim
                            ?>
                            <!----deyim kutusu başlangıç-->
                            <div class="col-sm-3">
                        ...
                        <input type="submit" value="<?php echo ('Deyimi Güncelle');?>" onClick="document.getElementById('phrase_form').submit();" class="btn btn-blue"/>	
                        <?php
                        echo form_close();
                        ?>                                     
                    </div>                
            ...
            <?php endif;?>
            <!----DEYİM DÜZENLEME TABLOSU SON-->
            <!----TABLO LİSTELEME BAŞLANGIÇ-->
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url();?>index.php?admin/manage_language/delete_language/<?php echo $field;?>"
                                    rel="tooltip" data-placement="top" data-original-title="<?php echo ('Dili Sil');?>" class="btn btn-gray" onclick="return confirm('Dili Sil ?');">
            ...
            <!----DEYİM OLUŞTURMA FORMU BAŞLANGIÇ---->
                    ...
                    <?php echo form_open(base_url() . 'index.php?admin/manage_language/add_phrase/' , array('class' => 'form-horizontal form-groups-bordered validate'));?>
                        <div class="padded">
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Deyim');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="phrase" data-validate="required" data-message-required="<?php echo ('Değer Gerekli');?>"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <button type="submit" class="btn btn-info"><?php echo ('Deyim Ekle');?></button>
                            </div>
                        </div>
                    <?php echo form_close();?>                
                </div>                
            </div>
            <!----DEYİM OLUŞTURMA FORMU SON--->
                    ...
                    <?php echo form_open(base_url() . 'index.php?admin/manage_language/add_language/' , array('class' => 'form-horizontal form-groups-bordered validate'));?>
                        <div class="padded">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="language" data-validate="required" data-message-required="<?php echo ('Değer Gerekli');?>"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <button type="submit" class="btn btn-info"><?php echo ('Dil Ekle');?></button>
                            </div>
                        </div>
                    <?php echo form_close();?> 
                </div>
            </div>
            <!----DİL EKLEME FORMU SON-->
        </div>
    </div>
</div>
