...
<div class="tab-pane box active" id="edit" style="padding: 5px">
    <div class="box-content">
        ...
        <?php echo form_open(base_url() . 'index.php?admin/class_routine/do_update/'.$row['class_routine_id'] , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <select name="day" class="form-control">
                        <option value="Saturday" 	<?php if($row['day']=='Saturday')echo 'selected="selected"';?>>Cumartesi</option>
                        <option value="Sunday" 		<?php if($row['day']=='Sunday')echo 'selected="selected"';?>>Pazar</option>
                        <option value="Monday" 		<?php if($row['day']=='Monday')echo 'selected="selected"';?>>Pazartesi</option>
                        <option value="Tuesday" 	<?php if($row['day']=='Tuesday')echo 'selected="selected"';?>>Salı</option>
                        <option value="Wednesday" 	<?php if($row['day']=='Wednesday')echo 'selected="selected"';?>>Çarşamba</option>
                        <option value="Thursday" 	<?php if($row['day']=='Thursday')echo 'selected="selected"';?>>Perşembe</option>
                        <option value="Friday" 		<?php if($row['day']=='Friday')echo 'selected="selected"';?>>Cuma</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label"><?php echo ('Başlangıç Saati');?></label>
                <div class="col-sm-5">
                    <?php 
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label"><?php echo ('Bitiş Saati');?></label>
                <div class="col-sm-5">
            ...
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-5">
                  <button type="submit" class="btn btn-info"><?php echo ('Ders Programını Düzenle');?></button>
              </div>
            </div>
        </form>
        <?php endforeach;?>
