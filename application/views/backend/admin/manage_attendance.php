...
<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped">
    <thead>
        <tr>
            <th><?php echo ('Tarih Seçiniz');?></th>
            <th><?php echo ('Ay Seçiniz');?></th>
            <th><?php echo ('Yıl Seçiniz');?></th>
            <th><?php echo ('Sınıf Seçiniz');?></th>
            <th><?php echo ('Tarih Seçiniz');?></th>
        </tr>
    </thead>
    <tbody>
        <form method="post" action="<?php echo base_url();?>index.php?admin/attendance_selector" class="form">
            <tr class="gradeA">
                ...
                <td>
                    <select name="month" class="form-control">
                        ...
                        for($i=1;$i<=12;$i++):
                            ...
                            else if($i==6)$m='Haziran';
                            else if($i==7)$m='Temmuz';
                            else if($i==8)$m='Ağustos';
                            else if($i==9)$m='Eylül';
                            else if($i==10)$m='Ekim';
                            else if($i==11)$m='Kasım';
                            else if($i==12)$m='Aralık';
                        ?>
                            <option value="<?php echo $i;?>"
                ...
                <td align="center"><input type="submit" value="<?php echo ('Devamsızlığı Yönet');?>" class="btn btn-info"/></td>
            </tr>
        </form>
    </tbody>
</table>
                ...
                <?php 
                    $students   =   $this->db->get_where('student' , array('class_id'=>$class_id))->result_array();
                        ...
                        <tr class="gradeA">
                            ...
                            <?php 
                                // Devamsızlık bilgisi öğrenci için mevcut değilse, boş veri eklenir.
                                ...
                                // Devamsızlık durumu düzenleme seçeneği gösterilir
                                $attendance = $this->db->get_where('attendance' , $verify_data)->row();
                                $status     = $attendance->status;
                            ?>
                        <?php if ($status == 1):?>
                            <td align="center">
                              <span class="badge badge-success"><?php echo ('Hazır');?></span>  
                            </td>
                        <?php endif;?>
                        <?php if ($status == 2):?>
                            <td align="center">
                              <span class="badge badge-danger"><?php echo ('Yok');?></span>  
                            </td>
                        <?php endif;?>
                        <?php if ($status == 0):?>
                            <td></td>
...
<!-- Öğrenci devamsızlık gönderme formu burada -->
<form method="post" 
                        ...
                        <tr class="gradeA">
                            ...
                            <td align="center">
                                ...
                                <select name="status_<?php echo $row['student_id'];?>" class="form-control" style="width:100px; float:left;">
                                    ...
                                    <option value="1" <?php if($status == 1)echo 'selected="selected"';?>>Hazır</option>
                                    <option value="2" <?php if($status == 2)echo 'selected="selected"';?>>Yok</option>
                                </select>
