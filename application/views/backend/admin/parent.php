...
<table class="table table-bordered table-hover table-striped datatable" id="table_export">
    <thead>
        <tr>
            ...
            <th><div><?php echo ('Telefon');?></div></th>
            <th><div><?php echo ('Meslek');?></div></th>
...
<!-----  VERİ TABLOSU DIŞA AKTARIM YAPILANDIRMALARI ---->                      
        ...
        var datatable = $("#table_export").dataTable({
            ...
            "oTableTools": {
                "aButtons": [
                    ...
                    {
                        "sExtends": "print",
                        "fnSetText"    : "Geri dönmek için 'esc' tuşuna basın",
