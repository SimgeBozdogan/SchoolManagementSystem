<!-- Kullanıcı Profil Bilgisi Düzenleme -->
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="nav nav-tabs bordered">
            <li class="active">
                <a href="#list" data-toggle="tab"><i class="entypo-user"></i> 
                    <?php echo ('Profil Bilgilerini Yönet');?>
                </a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            <!-- Profil Bilgisi Düzenleme Formu Başlangıç -->
                    ...
                    <?php echo form_open(base_url() . 'index.php?admin/manage_profile/update_profile_info' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <button type="submit" class="btn btn-info"><?php echo ('Profil Güncelle');?></button>
                            </div>
                        </div>
                    </form>
                    <?php
            ...
            <!-- Profil Bilgisi Düzenleme Formu Son -->
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="tab-content">
            <!-- Şifre Değiştirme Formu Başlangıç -->
            <div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content padded">
                    ...
                    <?php echo form_open(base_url() . 'index.php?admin/manage_profile/change_password' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo ('Mevcut Şifre');?></label>
                            <div class="col-sm-5">
                                <input type="password" class="form-control" name="password" value=""/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo ('Yeni Şifre');?></label>
                            <div class="col-sm-5">
                                <input type="password" class="form-control" name="new_password" value=""/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo ('Yeni Şifre Onayla');?></label>
                            <div class="col-sm-5">
