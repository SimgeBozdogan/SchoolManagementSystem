...
<div class="row">
    <div class="col-md-12">
        ...
        <!-- Kontrol Sekmeleri Başlangıç -->
        <ul class="nav nav-tabs bordered">
            <li class="active">
                <a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
                    <?php echo ('Notları Yönet');?>
                </a>
            </li>
        </ul>
        <!-- Kontrol Sekmeleri Son -->
        
        <!-- Notları Yönetme Tablosu Başlangıç -->
        <div class="tab-content <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result)) echo 'active'; ?>" id="list">
            <center>
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="table table-bordered table-hover table-striped">
                    <tr>
                        <td><?php echo ('Sınavı Seçiniz');?></td>
                        <td><?php echo ('Sınıfı Seçiniz');?></td>
                        <td><?php echo ('Konuyu Seçiniz');?></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td>
                            <select name="exam_id" class="form-control" style="float:left;">
                                <option value=""><?php echo ('Bir sınav seçin');?></option>
                                <?php 
                                ...
                                ?>
                                    <option value="<?php echo $row['class_id'];?>"
                                        <?php if($class_id == $row['class_id']) echo 'selected';?>>
                                            Sınıf <?php echo $row['name'];?></option>
                                <?php endforeach; ?>
                            </select>
                        </td>
                        <td>
                            ...
                            ?>
                                <select name="<?php if($class_id == $row['class_id']) echo 'subject_id'; else echo 'temp'; ?>" 
                                    ...
                                    <option value="">Sınıf <?php echo $row['name'];?> için Konu Seçin</option>
                        ...
                        <td>
                            ...
                            <input type="submit" value="<?php echo ('Notları Yönet');?>" class="btn btn-info" />
                        </td>
                    </tr>
                </table>
                </form>
            ...
            <!-- Not Girişi Başlangıç -->
            <?php if($exam_id > 0 && $class_id > 0 && $subject_id > 0): ?>
                <?php 
                    // EĞER KAYIT YOKSA NOT GİRİŞİNİ OLUŞTUR //
                ...
                <!-- Not Tablosu Başlangıç -->
                <table class="table table-bordered table-hover table-striped">
                    <thead>
                        <tr>
                            <td><?php echo ('Öğrenci');?></td>
                            <td><?php echo ('Alınan Not (Toplam 100)');?></td>
