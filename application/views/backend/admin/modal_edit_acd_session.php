		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title">
					...
					<?php echo ('Eğitim Oturumunu Düzenle');?>
            	</div>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select name="is_open" class="form-control">
                                <option <?php echo ($row['is_open']=='0')?'selected':'';?> value="0">Hayır</option>
                                <option <?php echo ($row['is_open']=='1')?'selected':'';?> value="1">Evet</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <button type="submit" class="btn btn-info"><?php echo ('Eğitim Oturumunu Düzenle');?></button>
                        </div>
                    </div>
                </form>
            </div>
